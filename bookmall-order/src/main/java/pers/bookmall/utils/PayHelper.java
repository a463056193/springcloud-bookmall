package pers.bookmall.utils;

import com.github.wxpay.sdk.WXPay;
import pers.bookmall.config.PayConfig;
import pers.bookmall.order.service.OrderService;
...
public class PayHelper {
    ...
    public String createPayUrl(Long orderId) {
        ...
        try {
            ...
            //回调地址，付款成功后的接口
            data.put("notify_url", "http://test.bookmall.com/wxpay/notify");
            // 交易类型为扫码支付
